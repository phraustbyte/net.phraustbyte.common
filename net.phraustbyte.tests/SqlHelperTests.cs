...
namespace net.phraustbyte.tests
{
    public class SqlHelperTests
    {
        ...
        public void TranslateSQL_To_Object_Success()
        {
            ...
            dataReader.Setup(m => m.GetName(1)).Returns("CreatedDate");
            dataReader.Setup(m => m.GetName(2)).Returns("Changer");
            dataReader.Setup(m => m.GetName(3)).Returns("Name");
            dataReader.Setup(m => m.GetName(4)).Returns("Active");
            dataReader.Setup(m => m.GetOrdinal("Id")).Returns(0);
            dataReader.Setup(m => m.GetOrdinal("CreatedDate")).Returns(1);
            dataReader.Setup(m => m.GetOrdinal("Changer")).Returns(2);
            dataReader.Setup(m => m.GetOrdinal("Name")).Returns(3);
            dataReader.Setup(m => m.GetOrdinal("Active")).Returns(4);
            ...
            dataReader.Setup(m => m.GetFieldType(4)).Returns(typeof(bool));
            dataReader.Setup(m => m.GetValue(0)).Returns(Guid.NewGuid());
            dataReader.Setup(m => m.GetValue(1)).Returns(DateTime.UtcNow);
            dataReader.Setup(m => m.GetValue(2)).Returns("ChangerString");
            dataReader.Setup(m => m.GetValue(3)).Returns("TestClassObject");
            dataReader.Setup(m => m.GetValue(4)).Returns(true);
            TestClass obj = SqlHelper.TranslateResults<TestClass>(dataReader.Object);
            Assert.NotNull(obj);
            Assert.True(obj.Id != new Guid());
